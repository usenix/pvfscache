...
static struct PINT_state_s ST_parent_getattr;
static struct PINT_pjmp_tbl_s ST_parent_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_parent_getattr_trtbl[];

static PINT_sm_action create_parent_getattr_inspect(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_parent_getattr_inspect;
static struct PINT_pjmp_tbl_s ST_parent_getattr_inspect_pjtbl[];
static struct PINT_tran_tbl_s ST_parent_getattr_inspect_trtbl[];

static PINT_sm_action create_create_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_create_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_create_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_create_setup_msgpair_trtbl[];
static struct PINT_state_s ST_create_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_create_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_create_xfer_msgpair_trtbl[];
...
static struct PINT_state_s ST_delete_handles_setup_msgpair_array;
static struct PINT_pjmp_tbl_s ST_delete_handles_setup_msgpair_array_pjtbl[];
static struct PINT_tran_tbl_s ST_delete_handles_setup_msgpair_array_trtbl[];
static struct PINT_state_s ST_delete_handles_xfer_msgpair_array;
static struct PINT_pjmp_tbl_s ST_delete_handles_xfer_msgpair_array_pjtbl[];
static struct PINT_tran_tbl_s ST_delete_handles_xfer_msgpair_array_trtbl[];
...
struct PINT_state_machine_s pvfs2_client_create_sm = {
	.name = "pvfs2_client_create_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
};
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_parent_getattr }
};

static struct PINT_state_s ST_parent_getattr = {
	 .state_name = "parent_getattr" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_parent_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_parent_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_parent_getattr_inspect },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_parent_getattr_inspect = {
	 .state_name = "parent_getattr_inspect" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_parent_getattr_inspect ,
	 .pjtbl = NULL ,
	 .trtbl = ST_parent_getattr_inspect_trtbl 
};

static struct PINT_tran_tbl_s ST_parent_getattr_inspect_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_setup_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_setup_msgpair = {
	 .state_name = "create_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_create_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_create_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_create_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_create_xfer_msgpair = {
	 .state_name = "create_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_create_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_crdirent_setup_msgpair = {
	 ...
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_crdirent_setup_msgpair ,
	 .pjtbl = NULL ,
...
static struct PINT_state_s ST_crdirent_failure = {
	 ...
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_crdirent_failure ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_crdirent_failure_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_delete_handles_setup_msgpair_array }
};

static struct PINT_state_s ST_delete_handles_setup_msgpair_array = {
	 .state_name = "delete_handles_setup_msgpair_array" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_delete_handles_setup_msgpair_array ,
	 .pjtbl = NULL ,
	 .trtbl = ST_delete_handles_setup_msgpair_array_trtbl 
};

static struct PINT_tran_tbl_s ST_delete_handles_setup_msgpair_array_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_delete_handles_xfer_msgpair_array },
	{ .return_value = -1 ,
	 .next_state = &ST_cleanup }
};

static struct PINT_state_s ST_delete_handles_xfer_msgpair_array = {
	 .state_name = "delete_handles_xfer_msgpair_array" ,
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_delete_handles_xfer_msgpair_array_trtbl 
};
...
static struct PINT_state_s ST_cleanup = {
	 ...
	 .parent_machine = &pvfs2_client_create_sm ,
	 .flag = SM_RUN ,
	 .action.func = create_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_cleanup_trtbl 
};

static struct PINT_tran_tbl_s ST_cleanup_trtbl[] = {
	{ .return_value = CREATE_RETRY ,
	 .next_state = &ST_init },
	{ .return_value = -1 ,
...
# 128 "src/client/sysint/sys-create.sm"
