...
static struct PINT_state_s ST_io_getattr;
static struct PINT_pjmp_tbl_s ST_io_getattr_pjtbl[];
static struct PINT_tran_tbl_s ST_io_getattr_trtbl[];

static PINT_sm_action io_inspect_attr(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_inspect_attr;
static struct PINT_pjmp_tbl_s ST_inspect_attr_pjtbl[];
static struct PINT_tran_tbl_s ST_inspect_attr_trtbl[];

static PINT_sm_action io_unstuff_setup_msgpair(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_unstuff_setup_msgpair;
static struct PINT_pjmp_tbl_s ST_unstuff_setup_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_unstuff_setup_msgpair_trtbl[];
static struct PINT_state_s ST_unstuff_xfer_msgpair;
static struct PINT_pjmp_tbl_s ST_unstuff_xfer_msgpair_pjtbl[];
static struct PINT_tran_tbl_s ST_unstuff_xfer_msgpair_trtbl[];

static PINT_sm_action io_datafile_setup_msgpairs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_datafile_setup_msgpairs;
static struct PINT_pjmp_tbl_s ST_io_datafile_setup_msgpairs_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_setup_msgpairs_trtbl[];
static struct PINT_state_s ST_small_io;
static struct PINT_pjmp_tbl_s ST_small_io_pjtbl[];
static struct PINT_tran_tbl_s ST_small_io_trtbl[];

static PINT_sm_action io_datafile_post_msgpairs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_datafile_post_msgpairs;
static struct PINT_pjmp_tbl_s ST_io_datafile_post_msgpairs_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_post_msgpairs_trtbl[];

static PINT_sm_action io_datafile_post_msgpairs_retry(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_datafile_post_msgpairs_retry;
static struct PINT_pjmp_tbl_s ST_io_datafile_post_msgpairs_retry_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_post_msgpairs_retry_trtbl[];

static PINT_sm_action io_datafile_complete_operations(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_datafile_complete_operations;
static struct PINT_pjmp_tbl_s ST_io_datafile_complete_operations_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_complete_operations_trtbl[];

static PINT_sm_action io_analyze_results(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_analyze_results;
static struct PINT_pjmp_tbl_s ST_io_analyze_results_pjtbl[];
static struct PINT_tran_tbl_s ST_io_analyze_results_trtbl[];
static struct PINT_state_s ST_io_datafile_size;
static struct PINT_pjmp_tbl_s ST_io_datafile_size_pjtbl[];
static struct PINT_tran_tbl_s ST_io_datafile_size_trtbl[];

static PINT_sm_action io_analyze_size_results(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_analyze_size_results;
static struct PINT_pjmp_tbl_s ST_io_analyze_size_results_pjtbl[];
static struct PINT_tran_tbl_s ST_io_analyze_size_results_trtbl[];

static PINT_sm_action io_cleanup(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_io_cleanup;
static struct PINT_pjmp_tbl_s ST_io_cleanup_pjtbl[];
static struct PINT_tran_tbl_s ST_io_cleanup_trtbl[];

struct PINT_state_machine_s pvfs2_client_io_sm = {
	.name = "pvfs2_client_io_sm",
	.first_state = &ST_init
};

static struct PINT_state_s ST_init = {
	 .state_name = "init" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_init ,
	 .pjtbl = NULL ,
	 .trtbl = ST_init_trtbl 
...
static struct PINT_tran_tbl_s ST_init_trtbl[] = {
	{ .return_value = -1 ,
	 .next_state = &ST_io_getattr }
};

static struct PINT_state_s ST_io_getattr = {
	 .state_name = "io_getattr" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_getattr_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_getattr_trtbl 
};

static struct PINT_tran_tbl_s ST_io_getattr_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_inspect_attr },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};

static struct PINT_state_s ST_inspect_attr = {
	 .state_name = "inspect_attr" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_inspect_attr ,
	 .pjtbl = NULL ,
	 .trtbl = ST_inspect_attr_trtbl 
};

static struct PINT_tran_tbl_s ST_inspect_attr_trtbl[] = {
	{ .return_value = IO_UNSTUFF ,
	 .next_state = &ST_unstuff_setup_msgpair },
	{ .return_value = IO_GETATTR_SERVER ,
	 .next_state = &ST_unstuff_setup_msgpair },
	{ .return_value = 0 ,
	 .next_state = &ST_io_datafile_setup_msgpairs },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};

static struct PINT_state_s ST_unstuff_setup_msgpair = {
	 .state_name = "unstuff_setup_msgpair" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_unstuff_setup_msgpair ,
	 .pjtbl = NULL ,
	 .trtbl = ST_unstuff_setup_msgpair_trtbl 
};

static struct PINT_tran_tbl_s ST_unstuff_setup_msgpair_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_unstuff_xfer_msgpair },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};

static struct PINT_state_s ST_unstuff_xfer_msgpair = {
	 .state_name = "unstuff_xfer_msgpair" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_msgpairarray_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_unstuff_xfer_msgpair_trtbl 
};
...
static struct PINT_state_s ST_io_datafile_setup_msgpairs = {
	 .state_name = "io_datafile_setup_msgpairs" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_datafile_setup_msgpairs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_setup_msgpairs_trtbl 
};

static struct PINT_tran_tbl_s ST_io_datafile_setup_msgpairs_trtbl[] = {
	{ .return_value = IO_NO_DATA ,
	 .next_state = &ST_io_cleanup },
	{ .return_value = IO_DO_SMALL_IO ,
	 .next_state = &ST_small_io },
	{ .return_value = 0 ,
	 .next_state = &ST_io_datafile_post_msgpairs },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};
...
static struct PINT_state_s ST_small_io = {
	 ...
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_small_io_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_small_io_trtbl 
};

static struct PINT_tran_tbl_s ST_small_io_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_io_analyze_results },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};

static struct PINT_state_s ST_io_datafile_post_msgpairs = {
	 .state_name = "io_datafile_post_msgpairs" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_datafile_post_msgpairs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_post_msgpairs_trtbl 
};

static struct PINT_tran_tbl_s ST_io_datafile_post_msgpairs_trtbl[] = {
	{ .return_value = IO_RETRY ,
	 .next_state = &ST_io_datafile_post_msgpairs_retry },
	{ .return_value = -1 ,
	 .next_state = &ST_io_datafile_complete_operations }
};

static struct PINT_state_s ST_io_datafile_post_msgpairs_retry = {
	 .state_name = "io_datafile_post_msgpairs_retry" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_datafile_post_msgpairs_retry ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_post_msgpairs_retry_trtbl 
};

static struct PINT_tran_tbl_s ST_io_datafile_post_msgpairs_retry_trtbl[] = {
	{ .return_value = IO_DATAFILE_TRANSFERS_COMPLETE ,
	 .next_state = &ST_io_analyze_results },
	{ .return_value = -1 ,
	 .next_state = &ST_io_datafile_post_msgpairs }
};
...
static struct PINT_state_s ST_io_datafile_complete_operations = {
	 .state_name = "io_datafile_complete_operations" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_datafile_complete_operations ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_complete_operations_trtbl 
};
...
static struct PINT_state_s ST_io_analyze_results = {
	 .state_name = "io_analyze_results" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_analyze_results ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_analyze_results_trtbl 
};

static struct PINT_tran_tbl_s ST_io_analyze_results_trtbl[] = {
	{ .return_value = IO_RETRY ,
	 .next_state = &ST_init },
	{ .return_value = IO_ANALYZE_SIZE_RESULTS ,
	 .next_state = &ST_io_analyze_size_results },
	{ .return_value = IO_GET_DATAFILE_SIZE ,
	 .next_state = &ST_io_datafile_size },
	{ .return_value = -1 ,
	 .next_state = &ST_io_cleanup }
};

static struct PINT_state_s ST_io_datafile_size = {
	 .state_name = "io_datafile_size" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_JUMP ,
	 .action.nested = &pvfs2_client_datafile_getattr_sizes_sm ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_datafile_size_trtbl 
};
...
static struct PINT_state_s ST_io_analyze_size_results = {
	 .state_name = "io_analyze_size_results" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_analyze_size_results ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_analyze_size_results_trtbl 
};
...
static struct PINT_state_s ST_io_cleanup = {
	 .state_name = "io_cleanup" ,
	 .parent_machine = &pvfs2_client_io_sm ,
	 .flag = SM_RUN ,
	 .action.func = io_cleanup ,
	 .pjtbl = NULL ,
	 .trtbl = ST_io_cleanup_trtbl 
};
...
# 255 "src/client/sysint/sys-io.sm"
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
    ...
    if (sm_p->u.io.msgpair_completion_count
     ...
     || sm_p->u.io.write_ack_completion_count)
        ...
        js_p->error_code = IO_RETRY;
        return SM_ACTION_COMPLETE;  /* means look at error_code and run my machine again */
    }
}
        ...
        struct PINT_smcb *smcb, job_status_s *js_p)
{
  ...
  check_next_step:
    ...
    /*
     * If something is pending, return SM_ACTION_DEFERRED to let SM find the next thing
     * to do.
     */
    if (sm_p->u.io.msgpair_completion_count
     || sm_p->u.io.flow_completion_count
