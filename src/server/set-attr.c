...
static struct PINT_state_s ST_write_metafile_datafile_handles_if_required;
static struct PINT_pjmp_tbl_s ST_write_metafile_datafile_handles_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_write_metafile_datafile_handles_if_required_trtbl[];

static PINT_sm_action setattr_write_metafile_distribution_if_required(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_write_metafile_distribution_if_required;
static struct PINT_pjmp_tbl_s ST_write_metafile_distribution_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_write_metafile_distribution_if_required_trtbl[];

static PINT_sm_action setattr_write_symlink_target_if_required(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_write_symlink_target_if_required;
static struct PINT_pjmp_tbl_s ST_write_symlink_target_if_required_pjtbl[];
static struct PINT_tran_tbl_s ST_write_symlink_target_if_required_trtbl[];

static PINT_sm_action setattr_setobj_attribs(
	struct PINT_smcb *smcb, job_status_s *js_p);

static struct PINT_state_s ST_setobj_attrib;
static struct PINT_pjmp_tbl_s ST_setobj_attrib_pjtbl[];
static struct PINT_tran_tbl_s ST_setobj_attrib_trtbl[];
...
struct PINT_state_machine_s pvfs2_set_attr_sm = {
	.name = "pvfs2_set_attr_sm",
	.first_state = &ST_prelude
};

static struct PINT_state_s ST_prelude = {
	 .state_name = "prelude" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_JUMP ,
...
static struct PINT_state_s ST_verify_attribs = {
	 ...
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_verify_attribs ,
	 .pjtbl = NULL ,
...
static struct PINT_tran_tbl_s ST_verify_attribs_trtbl[] = {
	{ .return_value = STATE_METAFILE ,
	 .next_state = &ST_write_metafile_datafile_handles_if_required },
	{ .return_value = STATE_SYMLINK ,
	 .next_state = &ST_write_symlink_target_if_required },
	{ .return_value = 0 ,
	 .next_state = &ST_setobj_attrib },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_write_metafile_datafile_handles_if_required = {
	 .state_name = "write_metafile_datafile_handles_if_required" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_write_metafile_datafile_handles_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_metafile_datafile_handles_if_required_trtbl 
};

static struct PINT_tran_tbl_s ST_write_metafile_datafile_handles_if_required_trtbl[] = {
	{ .return_value = 0 ,
	 .next_state = &ST_write_metafile_distribution_if_required },
	{ .return_value = -1 ,
	 .next_state = &ST_final_response }
};

static struct PINT_state_s ST_write_metafile_distribution_if_required = {
	 .state_name = "write_metafile_distribution_if_required" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_write_metafile_distribution_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_metafile_distribution_if_required_trtbl 
};
...
static struct PINT_state_s ST_write_symlink_target_if_required = {
	 .state_name = "write_symlink_target_if_required" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_write_symlink_target_if_required ,
	 .pjtbl = NULL ,
	 .trtbl = ST_write_symlink_target_if_required_trtbl 
};
...
static struct PINT_state_s ST_setobj_attrib = {
	 .state_name = "setobj_attrib" ,
	 .parent_machine = &pvfs2_set_attr_sm ,
	 .flag = SM_RUN ,
	 .action.func = setattr_setobj_attribs ,
	 .pjtbl = NULL ,
	 .trtbl = ST_setobj_attrib_trtbl 
};
